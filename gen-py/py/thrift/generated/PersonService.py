...
class Client(Iface):
    ...
    def savePerson(self, persion):
        ...
        """
        self.send_savePerson(persion)
        self.recv_savePerson()

    def send_savePerson(self, persion):
...
class Processor(Iface, TProcessor):
    ...
    def process_savePerson(self, seqid, iprot, oprot):
        ...
        result = savePerson_result()
        try:
            self._handler.savePerson(args.persion)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except DataException as dataException:
...
savePerson_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'persion', [Person, None], None, ),  # 1
)
